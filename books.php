...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    if(is_numeric($readLink)){
        $readLink = "https://www.gutenberg.org/ebooks/" . $readLink;
    }

    if(is_numeric($downloadLink)){
        $downloadLink = "https://www.gutenberg.org/ebooks/" . $downloadLink . ".epub.images";
    }
?>
    ...
    <div class="book-card">
        ...
        <div class="book-buttons">
            ...
            <a href="<?php echo htmlspecialchars($downloadLink); ?>" target="_blank">
